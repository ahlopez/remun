...
/*
   TODO:  >>>   Repensar esta clase.
   Ya no se requieren items que seleccionan productos.
   Ahora son parámetros que tienen nombre, tipo y valores según período

*/
class ContractParmEditor extends PolymerElement {
  static get template() {
    return html`
    ...
    <vaadin-form-layout id="form1">
      ...
      <vaadin-form-layout id="form2" colspan="16" class="parm" style="flex: auto;">
...
window.customElements.define(ContractParmEditor.is, ContractParmEditor);
