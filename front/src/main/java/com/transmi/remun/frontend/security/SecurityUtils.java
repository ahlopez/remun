...
import com.transmi.remun.frontend.errors.AccessDeniedView;
import com.transmi.remun.frontend.errors.CustomRouteNotFoundError;
...
public final class SecurityUtils
{
   ...
   */
  public static boolean isUserLoggedIn() { return isUserLoggedIn(SecurityContextHolder.getContext().getAuthentication()); }// isUserLoggedIn

  private static boolean isUserLoggedIn(Authentication authentication) { return authentication != null && !(authentication instanceof AnonymousAuthenticationToken); }// isUserLoggedIn
